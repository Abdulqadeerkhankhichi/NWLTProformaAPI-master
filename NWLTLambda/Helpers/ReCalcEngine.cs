...
namespace NWLTLambda
{
    public class ReCalcEngine
    {
        ...
        public StructureTypesVM ReCalcProforma(ParametersList mParams,string mStructType)
        {
            {
                ...
                //{
                        ...
                        double TempFARMax = Convert.ToDouble(FloorToAreaRatio) * Convert.ToDouble(mParams.LotSize);
                        double FARMax = (mParams.FarMax != TempFARMax && mParams.FarMax != 0 ? mParams.FarMax : TempFARMax);
                        if (TempFloorToAreaRatio != FloorToAreaRatio)
                        {
                            FARMax= Convert.ToDouble(FloorToAreaRatio) * Convert.ToDouble(mParams.LotSize);
                        }
                        ...
                        double TempNumberOfHomes = Math.Round(mParams.LotSize / Convert.ToDouble(mDig));
                        ...
                        if (mStructType == "Single Family")
                        {
                            ...
                            mSingleCalculation30.ParameterId = "30";
                            mSingleCalculation30.ParameterName = "Number of Homes";
                             TempNumberOfHomes = Math.Round(mParams.LotSize / Convert.ToDouble(mDig));
                    
                            NumberOfHomes = (mParams.Number_of_homes != TempNumberOfHomes && mParams.Number_of_homes != 0 ? mParams.Number_of_homes : TempNumberOfHomes);
                            mSingleCalculation30.value = NumberOfHomes.ToString();
                            mCalcList.Add(mSingleCalculation30);
                            ...
                            double TempSellableSquareFootage = (Convert.ToDouble(FARMax)  * SellableSqftFactor)/NumberOfHomes;
                            ...
                            double TempTotalFinancingCostConstructionFI = ((((TotalLandValueFI - EquityFI) + (TotalProjectCostFI / 2)) * ((InterestRateConstructionLoan) * (ConstructionLoanMonthsFI / 12))) + (((TotalProjectCostFI + TotalLandValueFI - EquityFI) * (LoanFeesConstructionLoanPI))));
                            ...
                            double TempTotalSalesCostPerLotPB = TotalSalesCostPerLot;
                            ...
                            double TempProfitPerLotBeforeFinancing = LotEstimatedValuePB - TotalBuildingCostPerLotPB - TotalSalesCostPerLotPB - ValueofLandPerLotPB;
                            ...
                            double TempTotalFinancingCostPF = TotalFinancingFeesFI;
                            ...
                            double TempNetProfitPerLotPF = ProfitPerLotBeforeFinancing - TotalFinancingCostPerHomePF;
                    ...
                    CalcParameterOutputModel mSingleCalculation96 = new CalcParameterOutputModel();
                            ...
                            mSingleCalculation140.ParameterId = "140";
                            mSingleCalculation140.ParameterName = "Total Sales Cost Per Project";
                            double TempTotalSalesCostPerProjectSCB = TotalSalesCostPerHomeSCB * NumberOfHomes;
                            ...
                            double TempTotalBuildingCostPerHomeLA = TotalBuildingCostPerHomeCB;
                            ...
                            double TempValueofLandPerHomeLA = HomeEstimatedValueLA - TotalBuildingCostPerHomeLA - TotalSalesCostPerHomeLA - DesiredProfitBeforeFinancingLA;
                            ...
                            mSingleCalculation62.ParameterId = "62";
                            mSingleCalculation62.ParameterName = "Total Financing Cost Construction";
                            double TempTotalFinancingCostConstructionFI = ((((TotalLandValueFI - EquityFI) + (TotalProjectCostFI / 2)) * ((InterestRateConstructionLoanFI) * (ConstructionLoanMonthsFI / 12))) + (((TotalProjectCostFI + TotalLandValueFI - EquityFI) * (LoanFeesConstructionLoanFI))));
                            double TotalFinancingCostConstructionFI = (mParams.TotalFinancingCostConstruction != TempTotalFinancingCostConstructionFI && mParams.TotalFinancingCostConstruction != 0 ? mParams.TotalFinancingCostConstruction : TempTotalFinancingCostConstructionFI);
                            mSingleCalculation62.value = TotalFinancingCostConstructionFI.ToString();
                            mCalcList.Add(mSingleCalculation62);
                        ...
                        else if (mStructType == "Condo")
                        {
                            ...
                            double tEMPmInefficientSpacePercentage = (mParams.InefficientSpacePercentage != mInefficientSpacePercentage && mParams.InefficientSpacePercentage != 0 ? mParams.InefficientSpacePercentage : mInefficientSpacePercentage);

                            mSingleCalculation79.value = tEMPmInefficientSpacePercentage.ToString();
                    ...
                    // - Livable Sqft (MAX FAR) – ((Inefficiency Space Percentage X MAX FAR))
                            ...
                            double TempLivableSqft = Convert.ToDouble(FARMax) - (mInefficientSpacePercentage * Convert.ToDouble(FARMax));
                    ...
                    double NumberofUnits = (mParams.NumberOfUnits != TempNumberofUnits && mParams.NumberOfUnits != 0 ? mParams.NumberOfUnits : TempNumberofUnits);
                            ...
                            mSingleCalculation62.ParameterId = "62";
                            mSingleCalculation62.ParameterName = "Total Financing Cost Construction";
                            double TempTotalFinancingCostConstructionFI = ((((TotalLandValuePF - EquityPF) + (TotalProjectCostFI / 2)) * ((InterestRateConstructionLoan) * (ConstructionLoanMonthsFI / 12))) + (((TotalProjectCostFI + TotalLandValuePF - EquityPF) * (LoanFeesConstructionLoanPF))));
                            double TotalFinancingCostConstructionFI = (mParams.TotalFinancingCostConstruction != TempTotalFinancingCostConstructionFI && mParams.TotalFinancingCostConstruction != 0 ? mParams.TotalFinancingCostConstruction : TempTotalFinancingCostConstructionFI);
                            mSingleCalculation62.value = TotalFinancingCostConstructionFI.ToString();
                            mCalcList.Add(mSingleCalculation62);
